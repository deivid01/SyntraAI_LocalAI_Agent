/**
 * HudCircle — Canvas 2D Jarvis HUD ring animation
...
export class HudCircle {
  ...
  private getStateColor(): string {
    switch (this.state) {
      case 'idle':       return '#00eaff';
      case 'listening':  return '#00eaff';
      case 'processing': return '#f0c040';
      case 'speaking':   return '#00ff9d';
    }
  }
...
(window as Window & { HudCircle?: typeof HudCircle }).HudCircle = HudCircle;
